...
export const Footer: React.FC<FooterProps> = ({ onAdminClick, onAboutClick }) => (
    ...
    <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-xs gap-4">
      <div className="flex flex-col md:flex-row items-center gap-2 md:gap-4">
        ...
        <button 
           ...
           className="text-space-600 hover:text-space-accent transition-colors flex items-center gap-1 mt-2 md:mt-0"
        >
